#ifndef GLORY_LUA_PARAMETER_DICTIONARY_H_
#define GLORY_LUA_PARAMETER_DICTIONARY_H_
...
class LuaParameterDictionary {
 public:
  ...
  LuaParameterDictionary(const std::string& code, FileResolver* file_resolver);
 ...
 private:
  ...
  LuaParameterDictionary(const std::string& code,
                         ReferenceCount reference_count,FileResolver* file_resolver);
                         //std::unique_ptr<FileResolver> file_resolver);
...
#endif  // GLORY_LUA_PARAMETER_DICTIONARY_H_
